...
export const fetchCategoriesPaginated = ({ page = 0, size = 10, search = "", sortField = "name", sortDir = "asc" }) =>
  api.get("/categories/paginated", { params: { page, size, search, sortField, sortDir } });
...
export const fetchItemsPaginated = ({ page = 0, size = 10, search = "", sortField = "name", sortDir = "asc" }) =>
  api.get("/items/paginated", { params: { page, size, search, sortField, sortDir } });
export const fetchItemsForWarehousePaginated = (
  warehouseId,
  { page = 0, size = 10, search = "", sortField = "name", sortDir = "asc" } = {}
) => api.get(`/items/warehouse/${warehouseId}`, { params: { page, size, search, sortField, sortDir } });
...
export const fetchSuppliersPaginated = ({ page = 0, size = 10, search = "", sortField = "name", sortDir = "asc" }) =>
  api.get("/suppliers/paginated", { params: { page, size, search, sortField, sortDir } });
...
export const fetchWarehousesPaginated = ({ page = 0, size = 10, search = "", sortField = "name", sortDir = "asc" }) =>
  api.get("/warehouses/paginated", { params: { page, size, search, sortField, sortDir } });
...
export const fetchPurchaseOrdersPaginated = ({
  ...
  api.get("/purchase-orders/paginated", { params: { page, size, search, sortField, sortDir } });
...
export const markPurchaseOrderReceived = (id) => api.put(`/purchase-orders/${id}/receive`);
...
export const fetchStockMovementsPaginated = ({
  ...
  sortField = "date",
  sortDir = "desc",
}) => api.get("/stock-movements/paginated", { params: { page, size, itemId, type, from, to, sortField, sortDir } });
...
// ---------------------- Issues ----------------------
export const fetchIssues = ({ page = 0, size = 10, search = "", status = "" } = {}) =>
  api.get("/issues", { params: { page, size, search: search || undefined, status: status || undefined } });
